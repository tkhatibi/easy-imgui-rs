...
#define GImGui MyImGuiTLS
    ...
    if implot {
        bindings = bindings
            ...
            // .clang_arg("-DIMPLOT_NO_FORCE_INLINE=1")
            // .clang_arg("-DIMGUI_HAS_TEXTURES=1")
            // .clang_arg("-DIMPLOT_POINT_CLASS_EXTRA=1")
            // .clang_arg("-DIMPLOT_MIX64=1")
            // .clang_arg("-DIMPLOT_CUSTOM_NUMERIC_TYPES=1")
            // .clang_arg("-DIMPLOT_INSTANTIATE_ALL_NUMERIC_TYPES=1")
            // .clang_arg("-DIMGUI_DISABLE=1")
